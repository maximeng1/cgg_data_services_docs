...
The endpoint is available on each country website, e.g.

`GET http://moneyhero.hk/api/events/submit`
...
Currently, we support TMG. However, there is some infrastructure in place to support LeadDesk also.
